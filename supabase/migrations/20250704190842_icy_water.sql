...
CREATE INDEX IF NOT EXISTS personal_records_achieved_at_idx ON personal_records(achieved_at);
CREATE INDEX IF NOT EXISTS personal_records_unique_record ON personal_records(user_id, exercise_name, record_type);