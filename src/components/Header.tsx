...
const Header = () => {
  ...
  return (
    <header className="bg-white bg-opacity-80 dark:bg-gray-800  dark:bg-opacity-80 backdrop-blur-md text-gray-900 dark:text-gray-100 shadow-md sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800">
