          ...
          <div className="pt-4 px-4 py-4">
            ...
            <div className="mt-4 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#dbf111] focus:border-[#dbf111]"
              />
              {searchTerm && (
                <button
              ...
              <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                {searchTerm ? (
                  <>
                    ...
                    <p className="text-sm mt-2">Try a different search term or add a custom exercise</p>
                  </>
                ) : (
